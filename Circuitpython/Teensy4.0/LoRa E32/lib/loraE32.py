...
class ebyteE32:
    ...
    # UART ports
    PORT = { 'U':[board.TX,board.RX], 'U1':[board.TX1,board.RX1], 'U2':[board.TX2,board.RX2], 'U3':[board.TX3,board.RX3], 'U4':[board.TX4,board.RX4] }
    # UART parity strings
    ...
    def start(self):
        ...
        try:
            ...
            # make UART instance
            self.serdev = busio.UART(ebyteE32.PORT.get(self.config['port'])[0], ebyteE32.PORT.get(self.config['port'])[1],timeout=0)
            # init UART
